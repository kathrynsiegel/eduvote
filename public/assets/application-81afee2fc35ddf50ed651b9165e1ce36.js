...
var createLecture = function(date) {
...
var ClassAdder = function(element){
  ...
  var parseResult = function(result) {
    ...
    if (name == null || name.length <= 1) {
      ...
      unreg_link = '<a data-confirm="Are you sure?" data-method="post" href="/users/unregister?course=' + id + '" rel = "nofollow">Unregister</a>'
      $('.courses').append('<tr><td><a href="/courses/' + id + '">' + name + '</a></td><td>' + number + '</td>'
                            + '<td>' + unreg_link + '</td>');
      $('#class-add-text').val('');
...
$(document).ready(function(){
  ...
  // $("#new-class").addClass("close_q");

  // $(".open_q").click(function(){
  // 	$("#new_course_options").hide();
  // 	$(this).html("Create New Question");
  // 	$(this).removeClass("open_q");
